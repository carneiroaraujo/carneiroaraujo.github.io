...
blocks['text_getSubstring'] = {
    ...
    init: function () {
        ...
        this.appendValueInput('STRING').setCheck('String').appendField(Msg['TEXT_GET_SUBSTRING_INPUT_IN_TEXT']);
...
blocks['text_changeCase'] = {
    ...
    init: function () {
        ...
        this.setStyle('text_blocks');
        this.appendValueInput('TEXT').setCheck('String').appendField(fieldRegistry.fromJson({
            type: 'field_dropdown',
            options: OPERATORS,
        }), 'CASE');
        this.setOutput(true, 'String');
...
const TEXT_INDEXOF_TOOLTIP_EXTENSION = function () {
    ...
    const thisBlock = this;
    this.setTooltip(function () {
        return Msg['TEXT_INDEXOF_TOOLTIP'].replace('%1', thisBlock.workspace.options.oneBasedIndex ? '0' : '-1');
    });
};
/**
