...
class BlockSvg extends Block {
    ...
    toCopyData() {
        ...
        return {
            saveInfo: blocks.save(this, { addCoordinates: true, addNextBlocks: false }),
    ...
    setColour(colour) {
        ...
        const styleObj = this.workspace.getRenderer().getConstants().getBlockStyleForColour(this.colour_);
    ...
    setStyle(blockStyleName) {
        const blockStyle = this.workspace.getRenderer().getConstants().getBlockStyle(blockStyleName);
    ...
    getFirstStatementConnection() {
        return super.getFirstStatementConnection();
    }
    /**
