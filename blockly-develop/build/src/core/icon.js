...
export class Icon {
    ...
    constructor(block) {
        ...
        this.iconXY_ = null;
        if (!block) {
            deprecation.warn('Calling the Icon constructor with a null block', 'version 9', 'version 10', 'a non-null block');
        }
        this.block_ = block;
    }
    ...
    createIcon() {
        ...
        browserEvents.conditionalBind(this.iconGroup_, 'pointerup', this, this.iconClick_);
        this.updateEditable();
    }
    ...
    computeIconLocation() {
        ...
        const iconXY = svgMath.getRelativeXY(this.iconGroup_);
        const newXY = new Coordinate(blockXY.x + iconXY.x + this.SIZE / 2, blockXY.y + iconXY.y + this.SIZE / 2);
