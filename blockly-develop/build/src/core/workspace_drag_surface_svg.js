...
export class WorkspaceDragSurfaceSvg {
    ...
    translateSurface(x, y) {
        ...
        dom.setCssTransform(this.SVG, 'translate3d(' + fixedX + 'px, ' + fixedY + 'px, 0)');
    }
    /**
    ...
    clearAndHide(newSurface) {
        ...
        const blockCanvas = this.SVG.childNodes[0];
        const bubbleCanvas = this.SVG.childNodes[1];
...
//# sourceMappingURL=workspace_drag_surface_svg.js.map