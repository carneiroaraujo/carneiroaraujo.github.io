 ...
 */
function tokenizeInterpolationInternal(message, parseInterpolationTokens) {
    const tokens = [];
                ...
                if (/[A-Z]\w*/i.test(rawKey)) { // Strict matching
                    ...
                    if (bklyKey && bklyKey in Msg) {
                        ...
                        if (typeof rawValue === 'string') {
                            ...
                            // end.
                            Array.prototype.push.apply(tokens, tokenizeInterpolationInternal(rawValue, parseInterpolationTokens));
                        }
