...
Object.defineProperties(Blockly, {
    ...
    alert: {
        set: function (newAlert) {
            deprecation.warn('Blockly.alert', 'version 9', 'version 10', 'Blockly.dialog.setAlert');
            dialog.setAlert(newAlert);
        },
        get: function () {
            deprecation.warn('Blockly.alert', 'version 9', 'version 10', 'Blockly.dialog.alert');
            return dialog.alert;
        },
    },
    /**
    ...
    confirm: {
        set: function (newConfirm) {
            deprecation.warn('Blockly.confirm', 'version 9', 'version 10', 'Blockly.dialog.setConfirm');
            dialog.setConfirm(newConfirm);
        },
        get: function () {
            deprecation.warn('Blockly.confirm', 'version 9', 'version 10', 'Blockly.dialog.confirm');
    ...
    mainWorkspace: {
        set: function (x) {
            deprecation.warn('Blockly.mainWorkspace', 'version 9', 'version 10', 'Blockly.getMainWorkspace');
    ...
    prompt: {
        set: function (newPrompt) {
            deprecation.warn('Blockly.prompt', 'version 9', 'version 10', 'Blockly.dialog.setPrompt');
            dialog.setPrompt(newPrompt);
        },
        get: function () {
            deprecation.warn('Blockly.prompt', 'version 9', 'version 10', 'Blockly.dialog.prompt');
    ...
    selected: {
        get: function () {
            deprecation.warn('Blockly.selected', 'version 9', 'version 10', 'Blockly.getSelected');
...
Object.defineProperties(ContextMenu, {
    ...
    currentBlock: {
        get: function () {
            deprecation.warn('Blockly.ContextMenu.currentBlock', 'September 2021', 'September 2022', 'Blockly.Tooltip.getCurrentBlock()');
            return ContextMenu.getCurrentBlock();
        },
        set: function (block) {
            deprecation.warn('Blockly.ContextMenu.currentBlock', 'September 2021', 'September 2022', 'Blockly.Tooltip.setCurrentBlock(block)');
...
Object.defineProperties(Events, {
    ...
    recordUndo: {
        get: function () {
            deprecation.warn('Blockly.Events.recordUndo', 'September 2021', 'September 2022', 'Blockly.Events.getRecordUndo()');
            return eventUtils.getRecordUndo();
        },
        set: function (record) {
            deprecation.warn('Blockly.Events.recordUndo', 'September 2021', 'September 2022', 'Blockly.Events.setRecordUndo()');
...
Object.defineProperties(Tooltip, {
    ...
    visible: {
        get: function () {
            deprecation.warn('Blockly.Tooltip.visible', 'September 2021', 'September 2022', 'Blockly.Tooltip.isVisible()');
    ...
    DIV: {
        get: function () {
            deprecation.warn('Blockly.Tooltip.DIV', 'September 2021', 'September 2022', 'Blockly.Tooltip.getDiv()');
...
Object.defineProperties(WidgetDiv, {
    ...
    DIV: {
        get: function () {
            deprecation.warn('Blockly.WidgetDiv.DIV', 'September 2021', 'September 2022', 'Blockly.WidgetDiv.getDiv()');
