...
export class Warning extends Icon {
    ...
    setVisible(visible) {
        ...
        eventUtils.fire(new (eventUtils.get(eventUtils.BUBBLE_OPEN))(this.getBlock(), visible, 'warning'));
        if (visible) {
            this.createBubble();
        }
        else {
    ...
    createBubble() {
        ...
        this.bubble_ = Bubble.createNonEditableBubble(this.paragraphElement, this.getBlock(), this.iconXY_);
        this.applyColour();
    }
