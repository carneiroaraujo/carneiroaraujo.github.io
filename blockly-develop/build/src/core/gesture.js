...
export class Gesture {
    ...
    constructor(e, creatorWorkspace) {
         ...
         * clientX/Y).
         */
        this.mouseDownXY_ = new Coordinate(0, 0);
        /**
    ...
    doBlockClick_() {
        ...
        if (this.flyout_ && this.flyout_.autoClose) {
            ...
            const event = new (eventUtils.get(eventUtils.CLICK))(this.startBlock_, this.startWorkspace_.id, 'block');
     ...
     */
    isFieldClick_() {
        const fieldClickable = this.startField_ ? this.startField_.isClickable() : false;
     ...
     */
    isWorkspaceClick_() {
        const onlyTouchedWorkspace = !this.startBlock_ && !this.startBubble_ && !this.startField_;
