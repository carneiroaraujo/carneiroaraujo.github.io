...
export class BlockDragSurfaceSvg {
    ...
    constructor(container) {
         ...
         */
        this.childSurfaceXY = new Coordinate(0, 0);
    ...
    translateAndScaleGroup(x, y, scale) {
        ...
        this.dragGroup.setAttribute('transform', 'translate(' + roundX + ',' + roundY + ') scale(' + scale + ')');
    }
    /**
     ...
     */
    getCurrentBlock() {
        return this.dragGroup.firstChild;
    }
    /**
...
//# sourceMappingURL=block_drag_surface.js.map