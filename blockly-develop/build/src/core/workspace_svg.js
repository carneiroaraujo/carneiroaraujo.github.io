...
export class WorkspaceSvg extends Workspace {
    ...
    constructor(options, opt_blockDragSurface, opt_wsDragSurface) {
        ...
        this.blockDragSurface = null;
        /** This workspace's drag surface, if it exists. */
        this.workspaceDragSurface = null;
        /**
         ...
         */
        this.audioManager =
            new WorkspaceAudio(options.parentWorkspace);
    ...
    setupDragSurface() {
        ...
        this.workspaceDragSurface.setContentsAndShow(this.getCanvas(), this.getBubbleCanvas(), previousElement, width, height, this.scale);
                ...
                do {
                    ...
                    if (!collide) {
                        ...
                        for (let i = 0, connection; connection = connections[i]; i++) {
                            const neighbour = (connection)
                                .closest(config.snapRadius, new Coordinate(blockX, blockY));
