...
class Block {
    ...
    jsonInit(json) {
        ...
        while (json['message' + i] !== undefined) {
            this.interpolate_(json['message' + i], json['args' + i] || [], json['lastDummyAlign' + i], warningPrefix);
            i++;
        }
    ...
    setCommentText(text) {
        ...
        eventUtils.fire(new (eventUtils.get(eventUtils.BLOCK_CHANGE))(this, 'comment', null, this.commentModel.text, text));
