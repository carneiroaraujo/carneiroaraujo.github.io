...
export class FieldVariable extends FieldDropdown {
    ...
    initModel() {
        ...
        const variable = Variables.getOrCreateVariablePackage(block.workspace, null, this.defaultVariableName, this.defaultType_);
    ...
    fromXml(fieldElement) {
        ...
        if (variableType !== null && variableType !== variable.type) {
            throw Error('Serialized variable type with id \'' + variable.getId() +
    ...
    doValueUpdate_(newId) {
        ...
        this.variable_ = Variables.getVariable(block.workspace, newId);
     ...
     */
    setTypes_(variableTypes = null, defaultType = '') {
