...
export function getRelativeXY(element) {
    deprecation.warn('Blockly.utils.getRelativeXY', 'December 2021', 'December 2022', 'Blockly.utils.svgMath.getRelativeXY');
 ...
 */
function getInjectionDivXY(element) {
    deprecation.warn('Blockly.utils.getInjectionDivXY_', 'December 2021', 'December 2022', 'Blockly.utils.svgMath.getInjectionDivXY');
...
export function tokenizeInterpolation(message) {
    deprecation.warn('Blockly.utils.tokenizeInterpolation', 'December 2021', 'December 2022', 'Blockly.utils.parsing.tokenizeInterpolation');
...
export function replaceMessageReferences(message) {
    deprecation.warn('Blockly.utils.replaceMessageReferences', 'December 2021', 'December 2022', 'Blockly.utils.parsing.replaceMessageReferences');
...
export function checkMessageReferences(message) {
    deprecation.warn('Blockly.utils.checkMessageReferences', 'December 2021', 'December 2022', 'Blockly.utils.parsing.checkMessageReferences');
...
export function is3dSupported() {
    deprecation.warn('Blockly.utils.is3dSupported', 'December 2021', 'December 2022', 'Blockly.utils.svgMath.is3dSupported');
...
export function getViewportBBox() {
    deprecation.warn('Blockly.utils.getViewportBBox', 'December 2021', 'December 2022', 'Blockly.utils.svgMath.getViewportBBox');
...
export function arrayRemove(arr, value) {
    deprecation.warn('Blockly.utils.arrayRemove', 'December 2021', 'December 2022', 'Blockly.array.removeElem');
...
export function getDocumentScroll() {
    deprecation.warn('Blockly.utils.getDocumentScroll', 'December 2021', 'December 2022', 'Blockly.utils.svgMath.getDocumentScroll');
...
export function getBlockTypeCounts(block, opt_stripFollowing) {
    deprecation.warn('Blockly.utils.getBlockTypeCounts', 'December 2021', 'December 2022', 'Blockly.common.getBlockTypeCounts');
...
export function screenToWsCoordinates(ws, screenCoordinates) {
    deprecation.warn('Blockly.utils.screenToWsCoordinates', 'December 2021', 'December 2022', 'Blockly.utils.svgMath.screenToWsCoordinates');
...
export function parseBlockColour(colour) {
    deprecation.warn('Blockly.utils.parseBlockColour', 'December 2021', 'December 2022', 'Blockly.utils.parsing.parseBlockColour');
...
export function runAfterPageLoad(fn) {
    deprecation.warn('Blockly.utils.runAfterPageLoad', 'December 2021', 'December 2022');
