...
class Debug {
    ...
    drawSpacerRow(row, cursorY, isRtl) {
        ...
        this.debugElements_.push(dom.createSvgElement(Svg.RECT, {
    ...
    drawConnection(conn) {
        ...
        this.debugElements_.push(dom.createSvgElement(Svg.CIRCLE, {
    ...
    drawRender(svgPath) {
        ...
        svgPath.setAttribute('filter', 'url(#' + this.constants.debugFilterId + ')');
        setTimeout(function () {
