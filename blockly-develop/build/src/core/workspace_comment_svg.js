...
class WorkspaceCommentSvg extends WorkspaceComment {
    ...
    render() {
        ...
        this.svgHandleTarget = dom.createSvgElement(Svg.RECT, { 'class': 'blocklyCommentHandleTarget', 'x': 0, 'y': 0 });
    ...
    setSize(width, height) {
        ...
        if (this.resizeGroup) {
            if (this.RTL) {
                ...
                this.resizeGroup.setAttribute('transform', 'translate(' + (-width + RESIZE_SIZE) + ',' +
