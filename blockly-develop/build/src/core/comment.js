...
export class Comment extends Icon {
    ...
    drawIcon_(group) {
        // Circle.
        dom.createSvgElement(Svg.CIRCLE, { 'class': 'blocklyIconShape', 'r': '8', 'cx': '8', 'cy': '8' }, group);
    ...
    createEditor() {
        /* Create the editor.  Here's the markup that will be generated in
           ...
           xmlns="http://www.w3.org/1999/xhtml" class="blocklyCommentTextarea"
             ...
             */
        this.foreignObject = dom.createSvgElement(Svg.FOREIGNOBJECT, { 'x': Bubble.BORDER_WIDTH, 'y': Bubble.BORDER_WIDTH });
        ...
        this.boundEvents.push(browserEvents.conditionalBind(textarea, 'focus', this, this.startEdit, true));
        // Don't zoom with mousewheel.
        this.boundEvents.push(browserEvents.conditionalBind(textarea, 'wheel', this, function (e) {
            e.stopPropagation();
        }));
        this.boundEvents.push(browserEvents.conditionalBind(textarea, 'change', this, 
        /**
         * @param _e Unused event parameter.
         */
        function (_e) {
            if (this.cachedText !== this.model.text) {
                eventUtils.fire(new (eventUtils.get(eventUtils.BLOCK_CHANGE))(this.getBlock(), 'comment', null, this.cachedText, this.model.text));
            }
        }));
        this.boundEvents.push(browserEvents.conditionalBind(textarea, 'input', this, 
        /**
         * @param _e Unused event parameter.
         */
        function (_e) {
    ...
    setVisible(visible) {
        ...
        eventUtils.fire(new (eventUtils.get(eventUtils.BUBBLE_OPEN))(this.getBlock(), visible, 'comment'));
    ...
    createEditableBubble() {
        ...
        this.bubble_ = new Bubble(block.workspace, this.createEditor(), block.pathObject.svgPath, this.iconXY_, this.model.size.width, this.model.size.height);
    ...
    createNonEditableBubble() {
        ...
        this.bubble_ = Bubble.createNonEditableBubble(this.paragraphElement_, this.getBlock(), this.iconXY_);
        this.applyColour();
    }
    /**
