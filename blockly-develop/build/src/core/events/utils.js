 ...
 * appear connected.
 */
export const BUMP_EVENTS = [BLOCK_CREATE, BLOCK_MOVE, COMMENT_CREATE, COMMENT_MOVE];
 ...
 */
function eventClassHasStaticFromJson(eventClass) {
    const untypedEventClass = eventClass;
