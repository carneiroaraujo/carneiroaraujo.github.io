...
Pygol['math_number_property'] = function (block) {
    ...
    const numberToCheck = Pygol.valueToCode(block, 'NUMBER_TO_CHECK', inputOrder) || '0';
    let code;
...
`);
        ...
        const divisor = Pygol.valueToCode(block, 'DIVISOR', Pygol.ORDER_MULTIPLICATIVE) || '0';
...
Pygol['math_change'] = function (block) {
    ...
    Pygol.definitions_['from_numbers_import_Number'] =
        'de numbers importe Number';
    const argument0 = Pygol.valueToCode(block, 'DELTA', Pygol.ORDER_ADDITIVE) || '0';
    const varName = Pygol.nameDB_.getName(block.getFieldValue('VAR'), NameType.VARIABLE);
...
Pygol['math_modulo'] = function (block) {
    ...
    const argument0 = Pygol.valueToCode(block, 'DIVIDEND', Pygol.ORDER_MULTIPLICATIVE) || '0';
    const argument1 = Pygol.valueToCode(block, 'DIVISOR', Pygol.ORDER_MULTIPLICATIVE) || '0';
    const code = argument0 + ' % ' + argument1;
    return [code, Pygol.ORDER_MULTIPLICATIVE];
};
Pygol['math_constrain'] = function (block) {
    // Constrain a number between two limits.
    const argument0 = Pygol.valueToCode(block, 'VALUE', Pygol.ORDER_NONE) || '0';
    const argument1 = Pygol.valueToCode(block, 'LOW', Pygol.ORDER_NONE) || '0';
    const argument2 = Pygol.valueToCode(block, 'HIGH', Pygol.ORDER_NONE) || 'real(\'inf\')';
