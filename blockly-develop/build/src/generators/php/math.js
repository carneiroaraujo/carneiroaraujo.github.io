...
PHP['math_number_property'] = function (block) {
    ...
    const numberToCheck = PHP.valueToCode(block, 'NUMBER_TO_CHECK', inputOrder) || '0';
    let code;
...
PHP['math_modulo'] = function (block) {
    ...
    const argument0 = PHP.valueToCode(block, 'DIVIDEND', PHP.ORDER_MODULUS) || '0';
...
PHP['math_constrain'] = function (block) {
    ...
    const argument2 = PHP.valueToCode(block, 'HIGH', PHP.ORDER_NONE) || 'Infinity';
