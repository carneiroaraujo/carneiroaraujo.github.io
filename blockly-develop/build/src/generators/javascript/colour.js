...
JavaScript['colour_rgb'] = function (block) {
    ...
    const green = JavaScript.valueToCode(block, 'GREEN', JavaScript.ORDER_NONE) || 0;
    const blue = JavaScript.valueToCode(block, 'BLUE', JavaScript.ORDER_NONE) || 0;
...
JavaScript['colour_blend'] = function (block) {
    ...
    const c2 = JavaScript.valueToCode(block, 'COLOUR2', JavaScript.ORDER_NONE) ||
        "'#000000'";
    const ratio = JavaScript.valueToCode(block, 'RATIO', JavaScript.ORDER_NONE) || 0.5;
