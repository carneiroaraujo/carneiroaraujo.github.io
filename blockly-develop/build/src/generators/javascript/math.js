...
JavaScript['math_single'] = function (block) {
    ...
    if (operator === 'NEG') {
        ...
        arg = JavaScript.valueToCode(block, 'NUM', JavaScript.ORDER_UNARY_NEGATION) || '0';
        if (arg[0] === '-') {
...
JavaScript['math_number_property'] = function (block) {
    ...
    const numberToCheck = JavaScript.valueToCode(block, 'NUMBER_TO_CHECK', inputOrder) || '0';
    let code;
...
`);
        ...
        const divisor = JavaScript.valueToCode(block, 'DIVISOR', JavaScript.ORDER_MODULUS) || '0';
...
JavaScript['math_on_list'] = function (block) {
    ...
    switch (func) {
        case 'SUM':
            ...
            break;
        case 'MIN':
            list = JavaScript.valueToCode(block, 'LIST', JavaScript.ORDER_NONE) || '[]';
...
JavaScript['math_modulo'] = function (block) {
    ...
    const argument0 = JavaScript.valueToCode(block, 'DIVIDEND', JavaScript.ORDER_MODULUS) || '0';
    const argument1 = JavaScript.valueToCode(block, 'DIVISOR', JavaScript.ORDER_MODULUS) || '0';
    const code = argument0 + ' % ' + argument1;
    return [code, JavaScript.ORDER_MODULUS];
};
JavaScript['math_constrain'] = function (block) {
    // Constrain a number between two limits.
    const argument0 = JavaScript.valueToCode(block, 'VALUE', JavaScript.ORDER_NONE) || '0';
    const argument1 = JavaScript.valueToCode(block, 'LOW', JavaScript.ORDER_NONE) || '0';
    const argument2 = JavaScript.valueToCode(block, 'HIGH', JavaScript.ORDER_NONE) || 'Infinity';
...
JavaScript['math_atan2'] = function (block) {
    ...
    const argument0 = JavaScript.valueToCode(block, 'X', JavaScript.ORDER_NONE) || '0';
    const argument1 = JavaScript.valueToCode(block, 'Y', JavaScript.ORDER_NONE) || '0';
