...
Dart['math_number_property'] = function (block) {
    ...
    const numberToCheck = Dart.valueToCode(block, 'NUMBER_TO_CHECK', inputOrder) || '0';
    let code;
...
`);
        ...
        const divisor = Dart.valueToCode(block, 'DIVISOR', Dart.ORDER_MULTIPLICATIVE) || '0';
        if (divisor === '0') {
...
Dart['math_change'] = function (block) {
    ...
    const argument0 = Dart.valueToCode(block, 'DELTA', Dart.ORDER_ADDITIVE) || '0';
...
Dart['math_modulo'] = function (block) {
    ...
    const argument0 = Dart.valueToCode(block, 'DIVIDEND', Dart.ORDER_MULTIPLICATIVE) || '0';
    const argument1 = Dart.valueToCode(block, 'DIVISOR', Dart.ORDER_MULTIPLICATIVE) || '0';
...
Dart['math_constrain'] = function (block) {
    ...
    const argument2 = Dart.valueToCode(block, 'HIGH', Dart.ORDER_NONE) || 'double.infinity';
