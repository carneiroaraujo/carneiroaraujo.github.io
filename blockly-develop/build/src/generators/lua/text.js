...
Lua['text_multiline'] = function (block) {
    ...
    const order = code.indexOf('..') !== -1 ? Lua.ORDER_CONCATENATION : Lua.ORDER_ATOMIC;
    return [code, order];
};
Lua['text_join'] = function (block) {
    ...
    if (block.itemCount_ === 0) {
        ...
        const element0 = Lua.valueToCode(block, 'ADD0', Lua.ORDER_CONCATENATION) || "''";
        const element1 = Lua.valueToCode(block, 'ADD1', Lua.ORDER_CONCATENATION) || "''";
