...
Python['text_multiline'] = function (block) {
    ...
    const order = code.indexOf('+') !== -1 ? Python.ORDER_ADDITIVE : Python.ORDER_ATOMIC;
    return [code, order];
};
/**
...
Python['text_join'] = function (block) {
    ...
    switch (block.itemCount_) {
        ...
        case 1: {
            const element = Python.valueToCode(block, 'ADD0', Python.ORDER_NONE) || "''";
            const codeAndOrder = forceString(element);
            return codeAndOrder;
        }
        case 2: {
            const element0 = Python.valueToCode(block, 'ADD0', Python.ORDER_NONE) || "''";
            const element1 = Python.valueToCode(block, 'ADD1', Python.ORDER_NONE) || "''";
...
Python['text_indexOf'] = function (block) {
    ...
    const substring = Python.valueToCode(block, 'FIND', Python.ORDER_NONE) || "''";
...
Python['text_charAt'] = function (block) {
    ...
    const textOrder = (where === 'RANDOM') ? Python.ORDER_NONE : Python.ORDER_MEMBER;
