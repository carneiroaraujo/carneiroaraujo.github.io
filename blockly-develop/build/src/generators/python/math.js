...
Python['math_number_property'] = function (block) {
    ...
    const numberToCheck = Python.valueToCode(block, 'NUMBER_TO_CHECK', inputOrder) || '0';
    let code;
...
`);
        ...
        const divisor = Python.valueToCode(block, 'DIVISOR', Python.ORDER_MULTIPLICATIVE) || '0';
...
Python['math_change'] = function (block) {
    ...
    Python.definitions_['from_numbers_import_Number'] =
        'from numbers import Number';
    const argument0 = Python.valueToCode(block, 'DELTA', Python.ORDER_ADDITIVE) || '0';
...
Python['math_modulo'] = function (block) {
    ...
    const argument0 = Python.valueToCode(block, 'DIVIDEND', Python.ORDER_MULTIPLICATIVE) || '0';
    const argument1 = Python.valueToCode(block, 'DIVISOR', Python.ORDER_MULTIPLICATIVE) || '0';
...
Python['math_constrain'] = function (block) {
    ...
    const argument2 = Python.valueToCode(block, 'HIGH', Python.ORDER_NONE) || 'float(\'inf\')';
