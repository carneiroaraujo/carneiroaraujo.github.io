 ...
 */
export declare function mixin(target: AnyDuringMigration, source: AnyDuringMigration): void;
/**
 ...
 */
export declare function deepMerge(target: AnyDuringMigration, source: AnyDuringMigration): AnyDuringMigration;
/**
 ...
 */
export declare function values(obj: AnyDuringMigration): AnyDuringMigration[];
